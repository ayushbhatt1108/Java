...
/**
 * This is also a classic example of run time polymorphism and its known as dynamic method dispacthing.
 * Lets try and undertand it with help of below example.
 * 
 * So we have 3 classes A,B & C where A is the parent of B & C .
 * All three of them has show method so basically in class B & C this show method is being overrided.
 * 
 * Now we have created an object of A obj = new A() and called obj.show.
 * 
 * Simply a refernce varibale obj of type A gets created in stack which is storing the mem location of a new object of A in heap.
 * This show method is present in the new object being created in heap and thus Dynamic method dispatched in A is printed.
 * 
 * Now obj = new B();
 * 
 * Meaning say previously obj was having address 101 which was pointing to an object of A.
